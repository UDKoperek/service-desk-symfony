 ...
 */
final class Version20251210004809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD created_at DATETIME NOT NULL, ADD session_token VARCHAR(255) DEFAULT NULL, ADD author_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP created_at, DROP session_token, DROP author_id');
    }
}
