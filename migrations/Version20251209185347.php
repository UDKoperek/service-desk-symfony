 ...
 */
final class Version20251209185347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, priority VARCHAR(20) DEFAULT NULL, session_token VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, author_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_97A0ADA3F675F31B (author_id), INDEX IDX_97A0ADA312469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
